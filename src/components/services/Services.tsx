...
const Services: React.FC<ServicesProps> = () => {
    return (
        <section id='services' className='w-full flex border-b-[1px] border-white/15 justify-center px-4 md:px-28 relative'>
            <div className='w-full flex flex-col gap-6 border-x-[1px] border-white/15 py lg:py-28 lg:px-20 md:py-20 md:px-10 py-10 sm:px-5'>
                ...
                <div className='pt-10 grid md:grid-cols-3 grid-cols-1'>
