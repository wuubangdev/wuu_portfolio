...
const HeroSection: React.FC = () => {
    return (
        <section id='home' className='w-full md:border-b-[1px] border-b-2 md:border-white/15 border-white md:min-h-screen min-h-[1000px] flex justify-center md:px-28 px-4 pt-22 relative'>
            <div className='w-full flex-1 flex flex-col items-center md:border-x-[1px] md:border-white/15 border-x-2 border-white relative'>
                {/* Hero text */}
